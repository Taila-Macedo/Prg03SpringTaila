...
public class CursoListar extends javax.swing.JFrame {
    ...
    public CursoListar() {
        ...
        try {
        cursoController = App.ctx.getBean(CursoController.class); // pega o bean Spring

        // Se o banco estiver vazio, adiciona cursos de exemplo
        if (cursoController.findAll().isEmpty()) {
        ...
        carregarTabela(cursoController.findAll());
    ...
    private void jTabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaMouseClicked
        ...
        List<Curso> cursosEncontrados = cursoController.findByNome(nomeCurso);
        ...
        if (coluna == 4) { // Remover
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                cursoController.delete(cursoSelecionado);
        ...
        if (coluna == 5) { // Editar
            CursoEditar tela = new CursoEditar(cursoSelecionado, this.cursoController);
    ...
    private void jbPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbPesquisarActionPerformed
       try {
            ...
            if (texto == null || texto.trim().isEmpty() || texto.equals("Pesquisar...")) {
                resultado = cursoController.findAll();
            } else {
                resultado = cursoController.findByNome(texto.trim());
            }
